...
perl -p -i -e 's/atccBAA[-,_]1512/Haloferax_mucosum/g' $1
perl -p -i -e 's/atccBAA[-,_]897/Haloferax_sulfurifontis/g' $1
...
perl -p -i -e 's/atccBAA[-,_]652/Haloarcula_sp_GUBF-9_ATCC_BAA_652/g' $1
...
perl -p -i -e 's/atccBAA[-,_]651/Haloarcula_sp_GUBF-8/g' $1
...
perl -p -i -e 's/atccBAA[-,_]1513/Haloferax_elongans/g' $1
...
perl -p -i -e 's/atccBAA[-,_]644/Haloferax_sp_GUBF-1/g' $1
perl -p -i -e 's/atccBAA[-,_]645/Haloferax_sp_GUBF-2/g' $1
perl -p -i -e 's/atccBAA[-,_]646/Haloferax_sp_GUBF-3/g' $1
