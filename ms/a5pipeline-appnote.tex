...
Short sequences are often highly erroneous and long sequences usually contain repetitive elements.
...
De novo genome assembly involves many steps. The two main steps are contiging and scaffolding.
In addition to these two steps,  
...
that is identified using FISH. Orange and black points correspond to orange and black lines on left.}\label{fig:01}
\end{figure}
