...
\begin{abstract}
Remarkable advances in DNA sequencing technology have created a profound need for \textit{de novo} genome assembly methods
tailored to work with the new sequencing data types. Assembling
raw sequence data to obtain a draft genome is usually a complex, multi-step process, 
involving several stages of sequence data cleaning, error reduction, and assembly quality control. 
...
\begin{table*}[!t]
\processtable{ Methodology for automatically setting parameters. 
\label{Tab:03}}
...
because it ranked among the best in two recent surveys of assembly algorithms~\citep{Earl2011,GAGE}, it is able to run on a single paired-end
