...
The probability of success $p$ in the Bernoulli process is set by calculating the minimum number of mapped reads
in any window of the genome assembly of length $L$, where $L = max(1000,\mu)$ for a library with mean insert $\mu$. 
