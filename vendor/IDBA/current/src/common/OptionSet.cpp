...
OptionSet::Option::Option(const string &long_name, const string &short_name,
...
string OptionSet::Option::ToString()
{
    string s;
...
void OptionSet::AddOption(const std::string &long_name, const std::string &short_name,
...
void OptionSet::ProcessOptions(int &argc, char *argv[])
{
...
void OptionSet::AddOption(const string &long_name, const string &short_name,
